...
//@TeleOp(name = "ChiefCardinal: Autonomous for Scrimmage v1")
public class ChiefCardinalAuto extends LinearOpMode {
    DcMotor LFMotor;
    DcMotor RFMotor;
    DcMotor LBMotor;
    DcMotor RBMotor;
...
//Game start.
        ...
        //Start driving to location in autonomous
            if (tagOfInterest.id == LEFT){
                drive("left",0.3,2.5);
                drive("forward",0.3,1.8);
...
//**DEACTIVATE for Autonomous
//**TEST commands to help with programming for Autonomous, right keypad on gamepad to run.
            //direction=forward, backward, right, left, turnRight, turnLeft; power [-1,+1]; time in seconds
//            if (gamepad1.y) {
//                drive("forward", 0.8, .3);
//            } else if (gamepad1.a) {
//                drive("backward", 0.8, .3);
//            } else if (gamepad1.b) {
//                drive("right", 0.8, .3);
//            } else if (gamepad1.x) {
//                drive("left", 0.8, .3);
//            } else if (gamepad1.right_bumper) {
//                drive("turnRight", 0.8, 0.5);
//            } else if (gamepad1.left_bumper) {
//                drive("turnLeft", 0.8, 0.5);
//            }
...
//            RBMotor.setPower(backRightPower);
    ...
    //Drive robot at desired direction at desired power for a desired time.
